package com.online.coursestore.manager.player
...
class VimeoVideoPlayerHelper constructor(private val vimeoPlayer: VimeoPlayerView) :
    ...
    private var mPlayerState: com.online.coursestore.model.PlayerState? = null
    ...
    override fun initPlayerFromState(playerState: com.online.coursestore.model.PlayerState) {
