...
class Quiz() : Parcelable, CourseCommonItem {
    ...
    @SerializedName("auth_can_download_certificate")
    var authCanDownloadCertificate = false
    ...
    constructor(parcel: Parcel) : this() {
        ...
        time = parcel.readInt()
        authCanDownloadCertificate = parcel.readByte() != 0.toByte()
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        ...
        parcel.writeByte(if (authCanDownloadCertificate) 1 else 0)
    ...
    override fun imgBgResource(context: Context): Int {
        return if (isCertificate) {
            ...
            R.drawable.round_view_certificate_corner10
        }
    }
