...
import com.online.coursestore.presenterImpl.LogoutPresenterImpl
import com.online.coursestore.ui.frag.*
import com.online.coursestore.ui.widget.AppDialog
import com.online.coursestore.ui.widget.CustomDuoDrawerLayout.LOCK_MODE_LOCKED_CLOSED
import com.online.coursestore.ui.widget.CustomDuoDrawerLayout.LOCK_MODE_UNLOCKED
...
//            }
        ...
        val addToBackstack = supportFragmentManager.backStackEntryCount == 0
...
//        val navEndColor = ContextCompat.getColor(this, R.color.bottom_nav_start_color)
//        bottomShape.colors = intArrayOf(navStartColor, navEndColor)

        if (mBinding.bottomNav.isVisible) {
            mBinding.bottomNav.setBackgroundColor(ContextCompat.getColor(this, R.color.bottom_nav_start_color))
        } else {
//            bottomShape.setColor(ContextCompat.getColor(this, R.color.pageBg))
            if (mBottomShape == null) {
                mBinding.mainContainer.setBackgroundColor(ContextCompat.getColor(this, R.color.bottom_nav_start_color))
            } else {
...
//                mCurrentFrag?.view?.background = bg
    ...
    override fun onBackPressed() {
        ...
        } else if (mCurrentBackStackCount == 0) {
