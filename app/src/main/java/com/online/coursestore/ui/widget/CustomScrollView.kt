...
//        }
        ...
        Log.d(TAG, "onTouchEvent: event.rawY:${event.rawY}")
        Log.d(TAG, "onTouchEvent: event.y:${event.y}")
        Log.d(TAG, "onTouchEvent: scrollY:${scrollY}")
        Log.d(TAG, "onTouchEvent: maxScrollAmount:${maxScrollAmount}")
