...
import com.online.coursestore.manager.adapter.QuizRvAdapter
import com.online.coursestore.manager.adapter.QuizStudentResultRvAdapter
...
import com.online.coursestore.presenterImpl.QuzziesPresenterImpl
...
class QuizzesFrag : NetworkObserverFragment(), OnItemClickListener, EmptyState {
    ...
    override fun onClick(view: View?, position: Int, id: Int) {
        ...
        if (mType == Type.MY_RESULT) {
        ...
        } else if (mType == Type.NOT_PARTICIPATED) {
            ...
            frag.arguments = bundle
        } else if (mType == Type.STUDENT_RESULT) {
