...
import com.online.coursestore.databinding.FragDashboardBinding
import com.online.coursestore.manager.App
import com.online.coursestore.manager.Utils
import com.online.coursestore.manager.adapter.DasboardGeneralSliderAdapter
...
//        chart.onChartGestureListener = this
    ...
    private fun addGeneralSlider(info: QuickInfo) {
        ...
        menuItem.title = ("${App.appConfig.currency.sign}${info.balance}")
        menuItem.desc = getString(R.string.account_balance)
        menuItem.type = DasboardGeneralSliderAdapter.Type.BALANCE.value
        ...
        if (info.badges?.nextBadge != null && !App.loggedInUser!!.isUser()) {
            ...
            menuItem.type = DasboardGeneralSliderAdapter.Type.BADGE.value
...
//        menuItem.type = DasboardGeneralSliderAdapter.Type.POINTS.value
//        menuItem.isClickable = true
//        menuItems.add(menuItem)

        mBinding.dashboardStatisticsViewPager.adapter =
            DasboardGeneralSliderAdapter(menuItems, requireActivity() as MainActivity)
...
//                return getString(R.string.pending_live_sessions)
                return getString(R.string.my_classes)
            }
