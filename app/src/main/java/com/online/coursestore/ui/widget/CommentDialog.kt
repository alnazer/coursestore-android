...
import com.online.coursestore.databinding.DialogBaseInputBinding
...
import com.online.coursestore.presenterImpl.ReportReplyCommentPresenterImpl
...
class CommentDialog : NetworkObserverBottomSheetDialog(), View.OnClickListener {
    ...
    companion object {
        val instance get() = CommentDialog()
    }
        ...
        when (v?.id) {
            ...
            R.id.baseInputBtn -> {
                ...
                when (mType) {
                    ...
                    Type.COMMENT_BLOG, Type.COMMENT_COURSE -> {
                        comment.itemId = mId
                        comment.itemName = if (mType == Type.COMMENT_BLOG) "blog" else "webinar"
