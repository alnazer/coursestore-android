...
import com.online.coursestore.databinding.DialogCourseOptionsBinding
            ...
            for (select in selected) {
                if (select.key == "type") {
                    when (select.value) {
                        ...
                        "coursestore" -> mBinding.courseOptionsCourseChbx.isChecked = true
        ...
        when (v?.id) {
            ...
            R.id.courseOptionsApplyBtn -> {
                ...
                if (mBinding.courseOptionsCourseChbx.isChecked) {
                    queryParams.add(KeyValuePair("type", "coursestore"))
                }
