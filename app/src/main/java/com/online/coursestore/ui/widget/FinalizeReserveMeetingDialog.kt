...
import com.online.coursestore.databinding.DialogFinalizeReserveMeetingBinding
...
import com.online.coursestore.presenterImpl.FinalizeReserveMeetingPresenterImpl
...
//        )!![1]
    ...
    private fun setPrice(belowMin: Boolean) {
        ...
        val price = "${App.appConfig.currency.sign} $amount"
    ...
    private fun updatePrice() {
        ...
        val btnText = "${getString(R.string.add_to_cart)} (${App.appConfig.currency.sign}$amount)"
