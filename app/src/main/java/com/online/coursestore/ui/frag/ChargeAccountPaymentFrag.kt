...
import com.online.coursestore.databinding.FragChargeAccountBinding
...
import com.online.coursestore.manager.adapter.PaymentGatewayGridAdapter
...
import com.online.coursestore.presenterImpl.ChargeAccountPaymentPresenterImpl
    ...
    override fun onClick(v: View?) {
        ...
        when (selectedgateway.id) {
            ...
            PaymentMethod.ACCOUNT_CHARGE.type -> {
                ...
                val uri = Uri.parse(BuildVars.PAYMENT_GATEWAY_URL)
                    .buildUpon()
...
//                mBinding.webView.postUrl(BuildVars.PAYMENT_GATEWAY_URL, postData.toByteArray())
